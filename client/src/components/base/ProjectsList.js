...
export const ProjectsList = (props) => {
  ...
  */
  ...
  const CellFormatter = (cell, row) => {
    return (<div><a href={URL+row.pid}>{cell}</a></div>);
  }
  ...
  return (
    <div>
       <BootstrapTable data={projects} striped hover options={options} >
        <TableHeaderColumn width="160px" isKey dataSort dataField="projectName" dataFormat={CellFormatter}><GoProject/> Project Name</TableHeaderColumn>
